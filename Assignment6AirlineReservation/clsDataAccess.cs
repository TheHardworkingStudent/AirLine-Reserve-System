...
namespace Assignment6AirlineReservation
{
    class clsDataAccess
    {
        ...
        /// <summary>
        /// <para>Inserts data</para>
        /// <para>Then gets the primary key of the newly inserted row and returns it.</para>
        /// </summary>
        /// <param name="insertSQL"></param>
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public int ExecuteInsertAndGetIdentity(string insertSQL)
        {
            try
            {
                int newId = 0;
            ...
            {
                // Handle exceptions
                throw new Exception("An error occurred while executing the SQL statements.", ex);
            }
        }
        /// <summary>
